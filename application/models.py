...
#no dot means it'll look in root directory
...
class User(db.Model) :
    ...
    headquarter = db.Column(db.String(200))
    ...
    drives = db.relationship('PlacementDrive', backref='company', cascade="all, delete")     #If company is deleted -> drives also deleted
